...
public class TreeRegistry {
    ...
    public static final RegisteredTree douglas = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "douglas", "Douglas Fir").wood(0xc18879).log(0x000000)
    ...
    public static final RegisteredTree pine = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "pine", "Pine").wood(0xb69a78).leaves(0x486942)
    ...
    public static final RegisteredTree larch = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "larch", "Larch").wood(0xeaac67).leaves(0x486942)
                    .feature((log, leaves) -> TreeMaker.makeNeedleTree(log, leaves, 2, 7, 3))
                    .biome(new BiomeSettings.Builder().temperature(0.4f).snow()).build());
    public static final RegisteredTree fir = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "fir", "Fir").wood(0xae8152).leaves(0x5a914e)
                    .feature((log, leaves) -> TreeMaker.makeNeedleTree(log, leaves, 1, 6, 2))
                    .biome(new BiomeSettings.Builder().temperature(0.4f).snow()).build());
    public static final RegisteredTree maple = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "maple", "Maple").wood(0xdc9971).leaves(0x9bd95d)
    ...
    public static final RegisteredTree japanese = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "japanese", "Japanese Maple").wood(0xef9085).leaves(0xb54c36)
                    .feature(TreeMaker::makeLeafTree).build());
    public static final RegisteredTree beech = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "beech", "Beech").wood(0x919773).log(0x000000).leaves(0xaadb69)
    ...
    public static final RegisteredTree cherry = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "cherry", "Cherry").wood(0xc35249).log(0x000000).leaves(0x81ba56)
    ...
    public static final RegisteredTree alder = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "alder", "Alder").wood(0xb0bb98).log(0x000000).leaves(0x589926)
    ...
    public static final RegisteredTree chestnut = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "chestnut", "Chestnut").wood(0x472024).log(0x000000)
    ...
    public static final RegisteredTree plane = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "plane", "Plane").wood(0x5a4e54).log(0x000000).leaves(0x8cb856)
    ...
    public static final RegisteredTree ash = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "ash", "Ash").wood(0xe88a4c).log(0x000000).leaves(0x79a348)
    ...
    public static final RegisteredTree linden = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "linden", "Linden").wood(0x65382b).log(0x000000).leaves(0x79a348)
                    .feature(TreeMaker::makeFancyLeafTree).build());
    public static final RegisteredTree robinia = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "robinia", "Robinia").wood(0x986508).leaves(0x97bf50)
    ...
    public static final RegisteredTree willow = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "willow", "Willow").wood(0xffdba5).leaves(0x75b354)
    ...
    public static final RegisteredTree pomegranate = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "pomegranate", "Pomegranate").wood(0xcfa67c).leaves(0x7dab48)
                    .feature((log, leaves) -> TreeMaker
    ...
    public static final RegisteredTree walnut = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "walnut", "Walnut").wood(0xd18e4f).leaves(0x6ba147).feature(
    ...
    public static final RegisteredTree cedar = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "cedar", "Cedar").leaves(0x5ea148).wood(0xf8747d).feature(
    ...
    public static final RegisteredTree poplar = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "poplar", "Poplar").leaves(0x81ba56).wood(0x7e98b3).feature(
    ...
    public static final RegisteredTree elm = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "elm", "Elm").wood(0xddbf5d).leaves(0xaed162)
    ...
    public static final RegisteredTree juniper = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "juniper", "Juniper").leaves(0x5ead55).wood(0x34595c).feature(
