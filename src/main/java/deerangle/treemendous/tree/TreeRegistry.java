...
public class TreeRegistry {
    ...
    public static final RegisteredTree douglas = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "douglas", "Douglas Fir").wood(MaterialColor.DIRT)
    ...
    public static final RegisteredTree pine = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "pine", "Pine").wood(MaterialColor.SAND).leaves(0x486942)
    ...
    public static final RegisteredTree fir = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "fir", "Fir").log(MaterialColor.OBSIDIAN).leaves(0x5a914e)
                    .feature((log, leaves) -> TreeMaker.makeNeedleTree(log, leaves, 1, 6, 2))
                    .biome(new BiomeSettings.Builder().temperature(0.4f).snow()).build());
    public static final RegisteredTree maple = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "maple", "Maple").wood(MaterialColor.DIRT).leaves(0x9bd95d)
    ...
    public static final RegisteredTree japanese = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "japanese", "Japanese Maple").wood(MaterialColor.PINK)
                    .leaves(0xb54c36).feature(TreeMaker::makeLeafTree).build());
    public static final RegisteredTree beech = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "beech", "Beech").wood(MaterialColor.GREEN)
    ...
    public static final RegisteredTree cherry = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "cherry", "Cherry").wood(MaterialColor.RED)
    ...
    public static final RegisteredTree alder = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "alder", "Alder").wood(MaterialColor.STONE)
    ...
    public static final RegisteredTree chestnut = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "chestnut", "Chestnut").wood(MaterialColor.BROWN)
    ...
    public static final RegisteredTree plane = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "plane", "Plane").wood(MaterialColor.CYAN_TERRACOTTA)
                    .log(MaterialColor.PURPLE).leaves(0x8cb856).biome(new BiomeSettings.Builder().temperature(0.8f))
                    .feature(TreeMaker::makePlaneTree).build());
    public static final RegisteredTree ash = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "ash", "Ash").wood(MaterialColor.ORANGE_TERRACOTTA)
    ...
    public static final RegisteredTree linden = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "linden", "Linden").wood(MaterialColor.ORANGE_TERRACOTTA)
                    .log(MaterialColor.BLACK).leaves(0x79a348).feature(TreeMaker::makeFancyLeafTree).build());
    public static final RegisteredTree robinia = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "robinia", "Robinia").wood(MaterialColor.GOLD).leaves(0x97bf50)
    ...
    public static final RegisteredTree willow = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "willow", "Willow").log(MaterialColor.BLACK)
    ...
    public static final RegisteredTree pomegranate = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "pomegranate", "Pomegranate").log(MaterialColor.GRAY_TERRACOTTA)
                    .wood(MaterialColor.WHITE_TERRACOTTA).leaves(0x7dab48).feature((log, leaves) -> TreeMaker
    ...
    public static final RegisteredTree magnolia = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "magnolia", "Magnolia").log(MaterialColor.LIGHT_GRAY)
    ...
    public static final RegisteredTree cedar = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "cedar", "Cedar").leaves(0x5ea148).wood(MaterialColor.PINK)
                    .feature((log, leaves) -> TreeMaker.makePointyTree(log, leaves, FeatureSpread.func_242252_a(37),
    ...
    public static final RegisteredTree poplar = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "poplar", "Poplar").leaves(0x81ba56).wood(MaterialColor.PINK)
    ...
    public static final RegisteredTree juniper = registerTree(
            TreeBuilder.create(BLOCKS, ITEMS, BIOMES, "juniper", "Juniper").leaves(0x5ead55).wood(MaterialColor.CYAN)
                    .feature((log, leaves) -> TreeMaker.makeJuniperTree(log, leaves, FeatureSpread.func_242252_a(42),
