...
public class CrossTrunkPlacer extends AbstractTrunkPlacer {
    ...
    public CrossTrunkPlacer(int baseHeight, int heightRandA, int heightRandB, FeatureSpread branchLength, FeatureSpread branchTopOffset, boolean leavesAtEnd) {
    ...
    public CrossTrunkPlacer(int baseHeight, int heightRandA, int heightRandB, FeatureSpread branchLength, FeatureSpread branchTopOffset, int leavesAtEnd) {
        this(baseHeight, heightRandA, heightRandB, branchLength, branchTopOffset, leavesAtEnd > 0);
    }
