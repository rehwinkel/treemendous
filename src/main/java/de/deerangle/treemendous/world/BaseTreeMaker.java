...
public class BaseTreeMaker {
    ...
    protected static ConfiguredFeature<TreeConfiguration, ?> makeSomeTree(Block leaves, Block wood, Block sapling) {
        return makeSomeTree(new SimpleStateProvider(leaves.defaultBlockState()), new SimpleStateProvider(wood.defaultBlockState()), new SimpleStateProvider(sapling.defaultBlockState()));
    }

    protected static ConfiguredFeature<TreeConfiguration, ?> makeSomeTree(BlockStateProvider leaves, BlockStateProvider wood, BlockStateProvider sapling) {
