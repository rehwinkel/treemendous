...
public class RangerHouseFeature extends StructureFeature<NoneFeatureConfiguration> {

    public RangerHouseFeature(Codec<NoneFeatureConfiguration> codec) {
        super(codec);
    }
    ...
    public static class FeatureStart extends StructureStart<NoneFeatureConfiguration> {
        ...
        public void generatePieces(RegistryAccess registryAccess, ChunkGenerator generator, StructureManager structureManager, ChunkPos chunkPos, Biome biome, NoneFeatureConfiguration config, LevelHeightAccessor heightAccessor) {
            ...
            RangerHouseStructurePiece piece = new RangerHouseStructurePiece(structureManager, STRUCTURE_LOCATION, blockpos, rotation);
            this.addPiece(piece);
        }
